...
interface Producto {
 ...
 export const ListaScreen: React.FC<{ navigation: any }> = ({ navigation }) => {
  ...
  const writeProductData = () => {
    ...
    set(dbRef, nuevoProducto)
      .then(() => {
        Alert.alert("Mensaje", "Libro registrado exitosamente.");
        setProductName("");
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.formContainer}>
        ...
        <View style={styles.inputContainer}>
          <Text style={styles.label}>Descripción del texto:</Text>
          <TextInput
        ...
        <View style={styles.inputContainer}>
          ...
          <TextInput
            ...
            placeholder="Introduce la categoría del Libro"
          />
        </View>
